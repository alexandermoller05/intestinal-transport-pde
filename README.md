...
The figure below shows the effect of viscosity on total glucose absorption after 3hrs when Axial dispersion is accounted for (alpha = 1) vs. not accounted for (alpha = 600).
